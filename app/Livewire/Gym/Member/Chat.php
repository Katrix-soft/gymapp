...
class Chat extends Component
{
    ...
    public function render()
    {
        ...
        // Get admins and trainers for the contact list
        $contactsQuery = User::role(['gym_admin', 'trainer']);
        ...
        foreach ($contactsRaw as $contact) {
            ...
            $contacts[] = [
                ...
                'name' => $contact->name,
                'email' => $contact->email,
                'role' => $contact->roles->first()->name ?? 'staff',
        ...
        // Sort contacts: unread and active conversations first
        ...
        return view('livewire.gym.member.chat', [
            'contacts' => $contacts,
