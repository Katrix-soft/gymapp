...
class Chat extends Component
{
    ...
    public function loadMessages()
    {
        ...
        $myId = auth()->id() ?? User::role('gym_admin')->first()->id;
    ...
    public function render()
    {
        ...
        // Fetch users for the chat list (excluding current user)
        ...
        // Sort contacts by last message timestamp (or name if no message exists)
        ...
        return view('livewire.gym.admin.chat', [
            'contacts' => $contacts,
