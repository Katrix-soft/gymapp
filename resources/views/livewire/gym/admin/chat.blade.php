        ...
        <div class="lg:col-span-8 flex flex-col h-full bg-zinc-950/5">
            ...
            @else
                ...
                <div class="flex-grow flex flex-col items-center justify-center text-center p-8">
                    ...
                    <p class="text-xs text-zinc-400 max-w-xs mt-1.5 leading-relaxed">Selecciona un socio o instructor del panel izquierdo para comenzar a chatear en tiempo real.</p>
                </div>
            @endif
